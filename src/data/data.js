...
"variables": {
		"attributes": {
			"strength": {"value": 15, "bonus": [], "sources": []},
			"str_mod": {"formula": "floor($.character.variables.attributes.strength / 2) - 5", "bonus": [], "sources": []},
			"dexterity": {"value": 15, "bonus": [], "sources": []},
			"dex_mod": {"formula": "floor($.character.variables.attributes.dexterity / 2) - 5", "bonus": [], "sources": []},
			"constitution": {"value": 15, "bonus": [], "sources": []},
			"con_mod": {"formula": "floor($.character.variables.attributes.constitution / 2) - 5", "bonus": [], "sources": []},
			"intelligence": {"value": 15, "bonus": [], "sources": []},
			"dex_mod": {"formula": "floor($.character.variables.attributes.intelligence / 2) - 5", "bonus": [], "sources": []},
			"wisdom": {"value": 15, "bonus": [], "sources": []},
			"wis_mod": {"formula": "floor($.character.variables.attributes.wisdom / 2) - 5", "bonus": [], "sources": []},
			"charisma": {"value": 15, "bonus": [], "sources": []},
			"cha_mod": {"formula": "floor($.character.variables.attributes.charisma / 2) - 5", "bonus": [], "sources": []}
		}
	}
};
*/
